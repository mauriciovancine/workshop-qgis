...
## 4. Sistema de Referência de Coordenadas
...
background-position: 25% 75%, 90% 50%
...
# Recapitulando: o Sistema de Referência de Coordenadas (*Coordinate Reference System* - CRS) é composto por:
<br><br><br>
...
### Sistema de Referência de Coordenadas (*Coordinate Reference System* - CRS)
...
## Sistemas de referências de coordenadas (CRS)
...
## Tipos de dados - Manipulados atrás de camadas (*layers*)
...
### Geopackage (Livre - QGIS) e Geodatabase (ArcGIS)
...
## Vamos abrir o QGIS clicando no ícone
...
background-image: url(img/qgis_plugin03.png), url(img/qgis_plugin_osm.png)
background-size: 700px, 100px
background-position: 50% 60%, 95% 10%
...
<p align="center">
<iframe width="60%" height="400" align="center" src="https://www.youtube.com/embed/OymQsu_ATW0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</p>
...
<p align="center">
<iframe width="60%" height="400" align="center" src="https://www.youtube.com/embed/qmNKs8-OQB0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</p>
...
# 5.7 Converter CRS de dados matriciais
