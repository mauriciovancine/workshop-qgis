...
background-image: url(img/qgis_plugins02.png), url(img/qgis_plugins_qpstools.svg)
background-size: 700px, 100px
...
background-image: url(img/qgis_plugins03.png), url(img/qgis_plugins_mapbiomas_coletion.svg)
background-size: 700px, 100px
background-position: 50% 60%, 95% 10%
...
background-image: url(img/qgis_plugins04.png), url(img/qgis_plugins_mapservices.svg)
background-size: 700px, 100px
background-position: 50% 60%, 95% 10%
