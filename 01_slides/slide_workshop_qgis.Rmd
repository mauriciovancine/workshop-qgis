...
### - Disponibilizar e indicar material
...
background-image: url(img/general_hard_soft-removebg-preview.png)
...
background-image: url(img/geo_geoprocessing04.jpg)
...
background-image: url(img/qgis_vetor06.png), url(img/qgis_vetor_calculate_field.svg)
background-size: 800px, 100px
background-position: 50% 80%, 95% 10%
...
background-image: url(img/qgis_raster01.png), url(img/geo_map_layout.svg)
background-size: 800px, 100px
background-position: 50% 85%, 95% 10%
