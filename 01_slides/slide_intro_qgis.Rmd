...
### Disponibilizar e indicar material para vocês se aprofundarem
...
background-position: 10% 30%, 30% 90%, 80% 90%
...
# 2.12 Conversão de dados geoespaciais (vetor-raster)
...
# 2.14. Material para estudo sobre geoprocessamento
...
> MapBiomas Collection (Coleção do MapBiomas)
...
> Por default o CRS do projeto é WGS84 / Geográfico
...
> Project > Properties > CRS > SIRGAS 2000 / UTM 23 S
